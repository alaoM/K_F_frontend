...
export const ProductSkeleton = ({ view }: { view: 'grid' | 'list' }) => {
  return (
    <div
      className={`bg-white  border border-gray-50 overflow-hidden animate-pulse ${view === 'list'
    ...
    >
      {/* Image */}
      <div
        className={`bg-gray-100 ${view === 'list' ? 'w-64 h-64 shrink-0 rounded-3xl' : 'h-80 w-full m-2 rounded-[2rem]'
          }`}
      />
